      ...
      >
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 text-white transition-colors relative overflow-hidden group"
            ...
            >
              ...
              <span className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left" />
            </Button>
          </form>
        </motion.div>
      </motion.div>
