...
import { Mic2, Globe, Users, Zap } from "lucide-react"
...
export default function HeroSection() {
  ...
  const stats = [
    { icon: <Mic2 className="w-6 h-6" />, label: "Languages", value: "50+" },
    { icon: <Globe className="w-6 h-6" />, label: "Platforms", value: "All" },
    { icon: <Users className="w-6 h-6" />, label: "Happy Users", value: "1000+" },
    { icon: <Zap className="w-6 h-6" />, label: "Real-time", value: "< 1s" },
  ]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-zinc-400 max-w-3xl mx-auto">
              Break language barriers in your meetings and videos with LiveTrad. Our browser extension connects to our
              desktop app to provide seamless real-time translation for any audio source.
            </p>
            <div className="relative inline-block">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="relative z-10">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 text-white text-lg px-8 py-6 rounded-full transition-colors relative overflow-hidden group"
